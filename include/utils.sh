...
function show_help() {
  ...
  echo "  -t                          Run in test mode. This is for development only and should not be run by regular users. This"
  echo "                              removes any checks for python and does not attempt to clone or update the repository. There"
  echo "                              is NO support provided when this is used."
